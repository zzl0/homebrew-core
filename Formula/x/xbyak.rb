class Xbyak < Formula
  ...
  url "https://github.com/herumi/xbyak/archive/refs/tags/v7.00.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "01710cd103eaba37e07cb8eea23665fcae20b4299278ca3b7dff607dc9b349c4"
  end
