class Deno < Formula
  ...
  url "https://github.com/denoland/deno/releases/download/v1.33.4/deno_src.tar.gz"
  ...
  resource "v8" do
    url "https://github.com/denoland/v8/archive/refs/tags/11.4.183.10-denoland-e4b0959f57c9090f124f.tar.gz"
