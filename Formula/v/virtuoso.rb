class Virtuoso < Formula
  ...
  url "https://github.com/openlink/virtuoso-opensource/releases/download/v7.2.10/virtuoso-opensource-7.2.10.tar.gz"
  sha256 "c02b0a966ff33f854a86f8f74caa8a5a957e22b510cc2f808e54ed34b4b27f0f"
  license "GPL-2.0-only" => { with: "openvpn-openssl-exception" }

  bottle do
    sha256 cellar: :any,                 arm64_sonoma:   "c4dfb9e4b02c20945f96f2b663c00034078ea0194db0aa8f6ee3e073dd753dd1"
    ...
    sha256 cellar: :any,                 sonoma:         "8e190c44c81776adfde7093164153b21404da30a51bad901f1cf7c27aa397af2"
