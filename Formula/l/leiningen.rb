class Leiningen < Formula
  ...
  url "https://github.com/technomancy/leiningen/archive/refs/tags/2.11.0.tar.gz"
  ...
  resource "jar" do
    url "https://github.com/technomancy/leiningen/releases/download/2.11.0/leiningen-2.11.0-standalone.jar"
