class DependencyCheck < Formula
  ...
  url "https://github.com/jeremylong/DependencyCheck/releases/download/v8.4.3/dependency-check-8.4.3-release.zip"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "5c3d1cc94e4fe40f3f9624f0d9557b28519a42afda2e68393c98814a691f1d57"
  end
